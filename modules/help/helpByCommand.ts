...
Optional parameters:
  ${cyan('-c')}                      Creates a new branch with the full suggested branch name 
                          (e.g. feature/ABC-1234-the-full-issue-title)
  ${cyan('-cs')}                     Creates a new branch with a short branch name (e.g. feature/ABC-1234)
  ${cyan('-ck')}                     Creates a new branch with only the issue key as branch name (e.g. ABC-1234)
